...
- **Формат:** 16:9, 27 слайдов (26 + 1 бонусный)
...
```
Декабрь 2025     Январь 2026        7–13 марта 2026
    ●─────────────────●──────────────────────●
...
## Слайд 11: Какая модель какой файл читает
...
Слева — deny-list (скриншот Carbon.now.sh, Dracula):
```json
"deny": [
  "Read(.env*)",               // 🔒 Секреты
  "Bash(rm *)", "Bash(del *)", // 🔒 Удаление
...
Справа — ключевые настройки:
- `"language": "russian"` — ответы на русском
- `"alwaysThinkingEnabled": true` — глубокий анализ
- `"defaultMode": "acceptEdits"` — авто-принятие правок

Подпись: **«Правила можно обойти, deny-list — нельзя»**

**Визуал:**
- Два блока: deny-list слева, настройки справа
- Под ними: "Уровень 1: Правила ⚠️" → "Уровень 2: Deny-list 🔒"

---

## Слайд 13: Memory Bank
...
## Слайд 15: God Objects — правило-защитник стало причиной
...
## Слайд 16: Агенты не следуют инструкциям
...
## Слайд 17: Слабые места — безопасность, инфра, Gemini
...
│                                                         │
│   ══════════════════════════════════════════════════════ │
│   Каждый усиливает вайб-кодинг. Вместе → agentic engineering   │
└─────────────────────────────────────────────────────────┘
```
...
## Слайд 21: Эмоциональная кривая ИИ-разработки
...
## Слайд 22: Стартер-кит — что получаете
...
## Слайд 27 (бонус): Заготовленные ответы на Q&A
