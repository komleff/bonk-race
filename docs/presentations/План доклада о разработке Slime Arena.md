...
### 3. Архитектура команды агентов (4 мин)
...
### 4. Инфраструктура и процессы (4 мин)
...
### 5. Технические достижения (3 мин)
...
### 6. Документация (объединено с блоком 4)
...
### 8. Где мы на карте: уровни агентной инженерии (3 мин)

> На основе статьи [«8 уровней агентной инженерии»](https://habr.com/p/1010430/)

**Тезисы:**

- Шкала от 1 (автодополнение) до 8 (автономные команды агентов)
- Наш профиль: уверенный 4 (накопление опыта), частично 5–6 (инструменты + обвязка)
- Следующий шаг: уровень 7 — фоновые агенты, оркестратор, автоматическое слияние
- Это не финальная точка — задача каждого определить свой уровень и двигаться дальше

**Вопросы для аудитории:**

- На каком уровне вы сейчас?
- Что мешает перейти на следующий?

### 9. Эффективность и сравнение (3 мин)
...
### 10. Roadmap: Полная автоматизация (3 мин)
...
## Таймлайн презентации (30 мин)

| Время | Блок                          | Формат                |
| ----- | ----------------------------- | --------------------- |
| 0-2   | Введение                      | Монолог               |
| 2-5   | Масштаб проекта               | Слайды + метрики      |
| 5-9   | Архитектура команды агентов   | Схема + примеры       |
| 9-13  | Инфраструктура и процессы     | Beads, Memory Bank    |
| 13-16 | Технические достижения        | Слайды                |
| 16-19 | Ошибки и уроки                | Топ-проблемы          |
| 19-22 | Эффективность и сравнение     | Таблица               |
| 22-24 | Уровни агентной инженерии     | Шкала, самооценка     |
| 24-27 | Roadmap + применимость        | Видение будущего      |
| 27-30 | Выводы + Q&A                  | Дискуссия             |
