...
| Лёд | Анизотропное: низкое трение, малое сцепление (SurfaceConfig) | Голубой | Нейтральная |
| Грязь | Высокое трение, сниженная скорость (SurfaceConfig) | Фиолетовый | Нейтральная |
| Песок | Вязкое замедление, затруднённые повороты (SurfaceConfig) | Жёлто-коричневый | Нейтральная |
| Лава | −2% массы в секунду | Оранжево-красный, мигающий | **ОПАСНОСТЬ** |
| Турбо | Доп. тяга по heading + повышенный лимит скорости (SurfaceConfig) | Синий | Позитивная |
