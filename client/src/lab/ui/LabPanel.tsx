        ...
        params: [
            {
                ...
                unit: "кг",
                tooltip:
                    "Масса персонажа. Влияет на инерцию, радиус и масштабирование сил.",
            },
            {
                ...
                unit: "м",
                tooltip:
                    "Радиус тела при базовой массе. Масштабируется как sqrt(масса).",
            },
            {
                label: "Коэф. инерции",
    ...
    // 3.11 Mass scaling
    {
        ...
        params: [
            ...
            },
            {
                ...
                max: 3.0,
                tooltip:
                    "Текущее значение 1.7 — компенсирует рост момента инерции.",
            },
            {
                ...
                max: 1.0,
                tooltip:
                    "0 = скорость одинакова для всех масс (текущее).",
            },
        ],
    },
];
