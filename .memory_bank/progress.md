...
- **last_checked_commit**: `bcdfdac` @ 10 марта 2026 (cleanup)
- **Активная ветка**: `feat/gdd-v4-ugc` (ожидает merge)
- **Production:** BonkLab на GitHub Pages, основная игра не задеплоена
- **Версия:** 0.1.0
- **GDD версия**: v4.0 (`docs/gdd/GDD-index.md`) — в PR #10

---

## Sprint 2 (2026-03-09/10) — BonkLab v1.2 — ЗАВЕРШЁН И MERGED

**Цель:** Орбы, финиш, настраиваемая геометрия, пресет-трекинг, rename slime→mud
**PR:** #9 (`feat/bonklab-v1.2`) — MERGED 10.03.2026
...
## PR #10 (2026-03-09/10) — GDD v4.0 — В РЕВЬЮ

**Ветка:** `feat/gdd-v4-ugc`
**Описание:** Обновление GDD v3.0 → v4.0: добавление UGC, русификация, спарение документа на 9 доменных файлов
**Статус:** Ревью обработано, все правки применены, отчёт опубликован, ожидает merge
**Ревьюеры:** GPT-5 Codex (полный обзор + проверка), Claude Opus 4.6 (правки)
**Коммиты:** 2 коммита (основной + cleanup)

### Что изменено

- ✅ Все 9 файлов GDD расколоты из монолита, русифицированы
- ✅ 3 противоречия в экономике исправлены
- ✅ UGC расширено: этапные ворота, модерация, групповые лидерборды, маркеры смерти
- ✅ Replay/ghost разделены (авторитативные команды vs производный артефакт)
- ✅ FTUE переработано: бесшовный туториал вместо подсказки
- ✅ 4 битые ссылки на старый GDD исправлены
- ✅ Временные файлы удалены, docs архивированы
